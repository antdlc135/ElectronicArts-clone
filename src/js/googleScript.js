export function googleScript() {
  ...
  (function (_) {
    ...
    try {
      ...
      _.Ra = function (a) {
        var b,
          c =
            null === (b = _.Ma()) || void 0 === b ? void 0 : b.createScript(a);
  ...
  */
      ...
      _.za = function (a) {
        return (
          (Object.prototype.hasOwnProperty.call(a, tb) && a[tb]) ||
          (a[tb] = ++vb)
        );
      };
        ...
        if (a) {
          ...
          d
            ...
            : ((this.offsetX =
              ...
              (this.offsetY =
                _.D || void 0 !== a.offsetY ? a.offsetY : a.layerY),
          ...
          for (var d = (c = !1); a.s.length && !a.B; ) {
            ...
            if ((f = a.l ? g : f))
              try {
                ...
                void 0 !== k &&
                  ((a.l = a.l && (k == b || k instanceof Error)),
                  (a.j = b = k));
                if (
                  re(b) ||
                  ("function" === typeof _.p.Promise &&
                    b instanceof _.p.Promise)
                )
                  (d = !0), (a.B = !0);
              } catch (l) {
                (b = l), (a.l = !0), Se(a) || (c = !0);
  ...
  */
      ...
      _._ModuleManager_initialize(
        "b/el_conf/sy1/sy0:2/sy3/sy2:3,4/el_main:5/el_sect:5/ajaxproxy/website_error/navigationui:3/_stam:2,4/n73qwf/MpJwZc",
        ["el_conf"]
      );
    } catch (e) {
      _._DumpException(e);
    ...
    try {
      ...
      MSGFUNC_PAGE_TRANSLATED_TO = function (a) {
        return "Google ha tradotto automaticamente questa pagina in: " + a;
      };
      K[3] = MSGFUNC_PAGE_TRANSLATED_TO;
      MSGFUNC_TRANSLATED_TO = function (a) {
        return "Tradotta in: " + a;
      };
      K[4] = MSGFUNC_TRANSLATED_TO;
      MSG_GENERAL_ERROR =
        "Errore. Impossibile completare la richiesta nel server. Riprova pi\u00f9 tardi.";
      K[5] = MSG_GENERAL_ERROR;
      MSG_LEARN_MORE = "Ulteriori informazioni";
      K[6] = MSG_LEARN_MORE;
      MSGFUNC_POWERED_BY = function (a) {
        return "Powered by " + a;
      };
      K[7] = MSGFUNC_POWERED_BY;
      MSG_TRANSLATE_PRODUCT_NAME = "Traduttore";
      K[8] = MSG_TRANSLATE_PRODUCT_NAME;
      MSG_TRANSLATION_IN_PROGRESS = "Traduzione in corso";
      K[9] = MSG_TRANSLATION_IN_PROGRESS;
      MSGFUNC_TRANSLATE_PAGE_TO = function (a) {
        return (
          "Tradurre questa pagina in " + a + " utilizzando Google Traduttore?"
        );
      };
      K[10] = MSGFUNC_TRANSLATE_PAGE_TO;
      MSGFUNC_VIEW_PAGE_IN = function (a) {
        return "Visualizza questa pagina in: " + a;
      };
      K[11] = MSGFUNC_VIEW_PAGE_IN;
      MSG_RESTORE = "Mostra originale";
      K[12] = MSG_RESTORE;
      MSG_SSL_INFO_LOCAL_FILE =
        "I contenuti di questo file locale saranno inviati a Google per essere tradotti utilizzando una connessione protetta.";
      K[13] = MSG_SSL_INFO_LOCAL_FILE;
      MSG_SSL_INFO_SECURE_PAGE =
        "I contenuti di questa pagina sicura saranno inviati a Google per essere tradotti utilizzando una connessione protetta.";
      K[14] = MSG_SSL_INFO_SECURE_PAGE;
      MSG_SSL_INFO_INTRANET_PAGE =
        "I contenuti di questa pagina intranet saranno inviati a Google per essere tradotti utilizzando una connessione protetta.";
      K[15] = MSG_SSL_INFO_INTRANET_PAGE;
      MSG_SELECT_LANGUAGE = "Seleziona lingua";
      K[16] = MSG_SELECT_LANGUAGE;
      MSGFUNC_TURN_OFF_TRANSLATION = function (a) {
        return "Disattiva traduzione di " + a;
      };
      K[17] = MSGFUNC_TURN_OFF_TRANSLATION;
      MSGFUNC_TURN_OFF_FOR = function (a) {
        return "Disattiva per: " + a;
      };
      K[18] = MSGFUNC_TURN_OFF_FOR;
      MSG_ALWAYS_HIDE_AUTO_POPUP_BANNER = "Nascondi sempre";
      K[19] = MSG_ALWAYS_HIDE_AUTO_POPUP_BANNER;
      MSG_ORIGINAL_TEXT = "Testo originale:";
      K[20] = MSG_ORIGINAL_TEXT;
      MSG_FILL_SUGGESTION = "Contribuisci a una traduzione migliore";
      K[21] = MSG_FILL_SUGGESTION;
      MSG_SUBMIT_SUGGESTION = "Contribuisci";
      K[22] = MSG_SUBMIT_SUGGESTION;
      MSG_SHOW_TRANSLATE_ALL = "Traduci tutto";
      K[23] = MSG_SHOW_TRANSLATE_ALL;
      MSG_SHOW_RESTORE_ALL = "Ripristina tutto";
      K[24] = MSG_SHOW_RESTORE_ALL;
      MSG_SHOW_CANCEL_ALL = "Annulla tutto";
      K[25] = MSG_SHOW_CANCEL_ALL;
      MSG_TRANSLATE_TO_MY_LANGUAGE = "Traduci le sezioni nella mia lingua";
      K[26] = MSG_TRANSLATE_TO_MY_LANGUAGE;
      MSGFUNC_TRANSLATE_EVERYTHING_TO = function (a) {
        return "Traduci tutto in " + a;
      };
      K[27] = MSGFUNC_TRANSLATE_EVERYTHING_TO;
      MSG_SHOW_ORIGINAL_LANGUAGES = "Mostra lingue originali";
      K[28] = MSG_SHOW_ORIGINAL_LANGUAGES;
      MSG_OPTIONS = "Opzioni";
      K[29] = MSG_OPTIONS;
      MSG_TURN_OFF_TRANSLATION_FOR_THIS_SITE =
        "Disattiva la traduzione per questo sito";
      K[30] = MSG_TURN_OFF_TRANSLATION_FOR_THIS_SITE;
      K[31] = null;
      MSG_ALT_SUGGESTION = "Mostra traduzioni alternative";
      K[32] = MSG_ALT_SUGGESTION;
      MSG_ALT_ACTIVITY_HELPER_TEXT =
        "Fai clic sulle parole riportate sopra per ottenere traduzioni alternative";
      K[33] = MSG_ALT_ACTIVITY_HELPER_TEXT;
      MSG_USE_ALTERNATIVES = "Utilizza";
      K[34] = MSG_USE_ALTERNATIVES;
      MSG_DRAG_TIP = "Trascina tenendo premuto MAIUSC per riordinare.";
      K[35] = MSG_DRAG_TIP;
      MSG_CLICK_FOR_ALT = "Fai clic per visualizzare le traduzioni alternative";
      K[36] = MSG_CLICK_FOR_ALT;
      MSG_DRAG_INSTUCTIONS =
        "Tieni premuto il tasto MAIUSC, fai clic e trascina le parole riportate sopra per riordinarle.";
      ...
      MSG_MANAGE_TRANSLATION_FOR_THIS_SITE =
        "Gestisci la traduzione per questo sito";
      K[39] = MSG_MANAGE_TRANSLATION_FOR_THIS_SITE;
      MSG_ALT_AND_CONTRIBUTE_ACTIVITY_HELPER_TEXT =
        "Fai clic su una parola per visualizzare le traduzioni alternative oppure fai doppio clic per apportare direttamente le modifiche";
      K[40] = MSG_ALT_AND_CONTRIBUTE_ACTIVITY_HELPER_TEXT;
      MSG_ORIGINAL_TEXT_NO_COLON = "Testo originale";
      K[41] = MSG_ORIGINAL_TEXT_NO_COLON;
      K[42] = "Traduttore";
      K[43] = "Traduci";
      K[44] = "La correzione \u00e8 stata inviata.";
      MSG_LANGUAGE_UNSUPPORTED =
        "Errore: la lingua della pagina web non \u00e8 supportata.";
      K[45] = MSG_LANGUAGE_UNSUPPORTED;
      MSG_LANGUAGE_TRANSLATE_WIDGET = "Widget di traduzione della lingua";
  ...
  //# sourceURL=/_/translate_http/_/js/k=translate_http.tr.it.132LABg9FZA.O/d=1/rs=AN8SPfogaUUBTkYvrS3YfCqflYfTOe4Yog/m=el_conf
  // Congigure Constants
  (function () {
    ...
    (function () {
      ...
      _loadCss(c._ps);
      _loadJs(
        "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.it.132LABg9FZA.O/am\x3dAQ/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfrsiAa_PkFPHsKBP2dEY-tUq50_FA/m\x3del_main"
      );
      _exportMessages();
      _exportVersion("TE_20220105");
    })();
  })();
}
